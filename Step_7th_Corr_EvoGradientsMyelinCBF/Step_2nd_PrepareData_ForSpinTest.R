...
WorkingFolder = paste0(ResultsFolder, '/Corr_EvoGradientsMyelinCBF');
SpinTest_Folder = paste0(WorkingFolder, '/PermuteData_SpinTest');
dir.create(SpinTest_Folder, recursive = TRUE);
VariabilityLabel_lh_CSV = data.frame(VariabilityLabel_lh = t(VariabilityLabel_Mat$VariabilityLabel.lh));
write.table(VariabilityLabel_lh_CSV, paste0(SpinTest_Folder, '/VariabilityLabel_lh.csv'), row.names = FALSE, col.names = FALSE);
VariabilityLabel_rh_CSV = data.frame(VariabilityLabel_rh = t(VariabilityLabel_Mat$VariabilityLabel.rh));
