...
Order = c(7, 6, 2, 9, 16, 3, 12, 1, 4, 15, 13, 11, 8, 17, 5, 10, 14);
...
ggplot(AllData, aes(x = Label, y = Variability, fill = Label, color = Label)) + 
      ...
      labs(x = "Networks", y = "Across-subjects Variability") + theme_classic() +
      ...
      scale_x_discrete(
            limits = c(7, 6, 2, 9, 16, 3, 12, 1, 4, 15, 13, 11, 8, 17, 5, 10, 14), 
            labels = c("12", "3", "6", "4", "10", "2", "11", "7", 
            "9", "5", "8", "13", "1", "14", "16", "15", "17")) +
