...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLabel_17_Kong/2Fold_Sort_Age');
...
Fig
ggsave(paste(WorkingFolder, '/AtlasLabel_17_Kong/AgePrediction_CorrACC.tiff', sep = ''), width = 17, height = 15, dpi = 300, units = "cm");
