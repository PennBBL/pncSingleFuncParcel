...
WorkingFolder <- '/data/jux/BBL/projects/pncSingleFuncParcel/results/PredictionAnalysis'
PredictionFolder <- paste0(WorkingFolder, '/AtlasLabel_17_Kong/2Fold_Sort_EFAccuracy');
...
Fig
ggsave(paste(WorkingFolder, '/AtlasLabel_17_Kong/EFAccuracyPrediction_CorrACC.tiff', sep = ''), width = 17, height = 15, dpi = 300, units = "cm");
