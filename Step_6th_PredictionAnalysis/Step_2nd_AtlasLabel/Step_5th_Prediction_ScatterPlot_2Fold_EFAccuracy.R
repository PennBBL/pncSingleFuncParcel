...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLabel_17_100/2Fold_Sort_EFAccuracy');
...
Fig
ggsave(paste(WorkingFolder, '/AtlasLabel_17_100/EFAccuracyPrediction_CorrACC.tiff', sep = ''), width = 17, height = 15, dpi = 300, units = "cm");
