...
PredictionFolder <- paste0(WorkingFolder, '/AtlasLabel_17_100/2Fold_Sort_Age');
...
Fig
ggsave(paste(WorkingFolder, '/AtlasLabel_17_100/AgePrediction_CorrACC.tiff', sep = ''), width = 17, height = 15, dpi = 300, units = "cm");
