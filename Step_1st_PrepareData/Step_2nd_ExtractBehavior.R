...
subjid_df <- read.csv("/data/jux/BBL/projects/pncSingleFuncParcel/Replication/data/pncSingleFuncParcel_n713_SubjectsIDs.csv");
#########################################
...
write.csv(demo, "/data/jux/BBL/projects/pncSingleFuncParcel/Replication/data/n713_Behavior_20181219.csv", row.names = FALSE);
